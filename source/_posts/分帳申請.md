...
<div class="col-6">
<input class="form-control bg-dark" id="discordTag2" name="discordTag"2 type="text" placeholder="範例: NCT skyouo#3144" onfocusout="checkDiscordTagWithProxy2()" required>
