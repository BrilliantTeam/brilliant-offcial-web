...
<div class="col-6">
<input class="form-control bg-dark" id="minecraftName" name="name" type="text" placeholder="範例: Senz0309" onfocusout="checkMinecraftNameWithProxy2()" required>
...
<div class="col-6">
<input class="form-control bg-dark" id="discordTag" name="discordTag" type="text" placeholder="範例: NCT skyouo#3144" onfocusout="checkDiscordTagWithProxy2()" required>
