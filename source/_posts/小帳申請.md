...
在申請時您需要提供以下資訊給予輝煌團隊進行判斷:
           ...
           2. 欲申請小帳的遊戲ID ( 須註明 基岩版 還是 Java版 )
           
           3. 您的Discord名稱#四位數號碼
           
           4. 欲申請帳號的Discord名稱#四位數號碼

           5. 為什麼您需要使用小帳 ( 需詳細說明原因, 這是審核的重要評斷 )
...
或者 給予警告處分:
           ...
           4. 您的小帳有違規紀錄，或者在申請通過後違規 ( 拔除資格+處分 )
