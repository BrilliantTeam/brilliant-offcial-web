...
<details>
  <summary>以下為 <font color="#ff7a7a">自定義專屬個人稱號</font> 申請辦法</summary>

1. 稱號字數最多 <font color="#a4ff88">4 個字</font> + 最多 <font color="#a4ff88">1 本群靜態表符</font> 。
2. 稱號中只能使用 <font color="#a4ff88">一種</font> 顏色代碼，可使用 <font color="#ffbb06">十六進制色碼</font> 。
3. 稱號名 <font color="#a4ff88">不可</font> 與官方、活動、乙太、水芥 稱號相似，避免誤會。
4. 稱號名稱不可違反 <font color="#a4ff88">服規二</font> 所規範內容。
5. 稱號建立後，<font color="#a4ff88">不得修改</font> 。
...
<font color="#a4ff88">【自定義專屬個人稱號】</font> 規範如同 <font color="#ffbb06">3470 新台幣以上回饋</font> 所述，
