...
1. 給予我們您的 <span class="label label-info">SKIN 檔案（.png）</span>
2. 可以自定義玩偶的【名字】，或者使用遊戲ID。
3. 可以自定義玩偶的【物品描述】，或者留空。
4. 選擇在在哪一個分流領取 1 個 <font color="#ff7a7a">【屬於自己的專屬遊戲人偶】</font>
5. 於 <span class="label label-info">/spawn</span> 的【贊助感謝牆】上的【顯示名稱】，或者使用遊戲ID、匿名。

隨後，這個玩偶將被加入【輝煌伺服器材質包當中】，
並放置於 <span class="label label-info">/spawn</span> 的【贊助感謝牆】上。
</details>
