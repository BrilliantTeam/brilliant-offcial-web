...
<div class="form-group mb-4">
  ...
  <div class="col-6 px-0">
    <input 
      ...
      name="name" 
      type="text" 
      placeholder="範例：RiceChen_" 
      onfocusout="checkMinecraftNameWithProxy()" 
      required
    >
...
<div class="form-group mb-4">
  ...
  <div class="col-6 px-0">
    <input 
      ...
      name="discordTag" 
      type="text" 
      placeholder="範例：ricechen_#0" 
      onfocusout="checkDiscordTagWithProxy()" 
      required
    >
...
<div class="form-group mb-4">
  ...
  <div class="col-6 px-0">
    <input 
      ...
      name="donateAmount" 
      type="text" 
      placeholder="一次最低 30 元 最高 10000 元" 
