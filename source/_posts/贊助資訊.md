...
- 累積贊助達 <font color="#ffbb06">1170</font> 新台幣後，將可以在<span class="label label-success"><a href="https://www.brilliantw.net/贊助資訊/#資金使用題">【全世界範圍】</a></span>任意飛行，不再限於領地內。
...
此福利暫未開放！
{% endnote %}
累積贊助達 <font color="#ffbb06">1170</font> 新台幣後，將可以在<span class="label label-success">【全世界範圍】</span>任意飛行，不再限於領地內。
以下為相關機制說明：
...
<table>
  <tr>
    <th>贊助額度</th>
    <th>首次達到該額度可獲【跨分流飛行點數】量</th>
    <th>在線上時，恢復的【當前分流飛行點數】量</th>
    <th>後續每贊助<font color="#ffbb06">1</font>新台幣後，恢復的【跨分流飛行點數】量</th>
    <th>飛行點數上限</th>
  </tr>
  <tr>
    <td>1170 元</td>
...
### 飛行點數是什麼？
【飛行點數】分為【當前分流飛行點數】與【跨分流飛行點數】兩種，
這兩種飛行點數都將顯示為一個【飛行點數】數值，
以下為【飛行點數】說明：

#### 【當前分流飛行點數】
當你在某一分流上線/飛行時
將恢復/扣除的點數值，例如你的飛行點數有 50 秒
你在第一分流飛行 10 秒後，第一分流的飛行點數將剩下 40 秒
但是第二分流的點數依然是 50 秒

#### 【跨分流飛行點數】
以 &a贊助方式 獲取的點數值，
例如你的飛行點數有 50 秒，
你贊助了一定金額後，獲取了 10 秒的點數，
那麼在第一、第二分流中，其【當前分流飛行點數】都會是 60 秒。

### 飛行點數恢復方式
當您於【領地外】的區域飛行時，將扣除【當前分流飛行點數】，
當您於【領地內】飛行時，不會扣除【當前分流飛行點數】，
以下為此階級之數值：

   1. 持續在線上 600 秒，將根据階級，來恢復【當前分流飛行點數】。
   2. 每贊助 1 新台幣，將根据階級，來恢復【跨分流飛行點數】。
      並且以贊助方式獲取的【跨分流飛行點數】，可超出【飛行點數上限】。

### 飛行點數上限是什麼？
當恢復的【飛行點數】達到【飛行點數上限】時，
將不再以玩家在線上的方式來恢復【飛行點數】
除非【飛行點數】被消耗至未達上限，玩家在線時才會自動恢復。
而根據階級的不同，飛行點數的恢復上限也會有所不同。
