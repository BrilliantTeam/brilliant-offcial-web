...
<table>
  ...
  <tr>
    ...
    <td>月卡（5 月）</td>
    <td>1. <font color="#f7c848">餅乾供應</font> 限定身份組。<br />2. 使用 <font color="#f7c848">/coler set</font> 指令自定義顏色身份組。</td>
    <td>1. <font color="#f7c848">餅乾供應</font> 限定稱號。<br />2. 每日任務數量增加 <font color="#ff4e4e">5</font> → <font color="#b5fe4e">7</font> 個。<br />3. 每周任務數量增加 <font color="#ff4e4e">3</font> → <font color="#b5fe4e">5</font> 個。4. 5 個 <font color="#f7e1a4">汙染清除裝置</font>。</td>
