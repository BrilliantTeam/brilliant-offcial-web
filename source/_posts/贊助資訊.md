...
- 選擇贊助感謝公告的發佈方式 (遊戲內)
<select class="form-select" aria-label="publish-way">
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <div class="input-group-text">
      <input type="checkbox" aria-label="同意服務條款">
    </div>
  </div>
  <input type="text" class="form-control" aria-label="最後付款前，請確定您已查閱好本服相關的<a href=\"https://www.brilliantw.net/服務條款\">服務條款</a>">
</div>

<input class="btn btn-primary" type="button" value="已確認填寫資訊無誤 前往付款">
