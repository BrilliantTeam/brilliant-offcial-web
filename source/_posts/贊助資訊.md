...
<div class="form-check">
    ...
    <label for="check-tos"> 最後付款前，請確定您已查閱好本服相關的<a href="https://www.brilliantw.net/服務條款">服務條款</a></label>
</div>
  
  <button class="btn btn-primary" type="submit" value="已確認填寫資訊無誤 前往付款"></button>
  </form>
