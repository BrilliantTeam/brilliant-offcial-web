...
window.onload = function() {
  ...
  formSubmit = () => {
    ...
    .then(data => {
      if (data.status) {
        const paymentWindow = window.open('', '_BrilliantDonation');
        const messageLines = data.message.split('\n').map(line => `<p>${line}</p>`).join('');
        
        // 如果有 barcodeImage，顯示圖片；否則只顯示文字
        ...
        paymentWindow.document.write(`
          ...
          <head>
              ...
              <style>
                  ...
                  .cool-btn:hover {
                      ...
                      box-shadow: 0 15px 20px rgba(255, 65, 108, 0.4);
                  }
                  .cool-btn:active {
          ...
          <body>
              <div class="container">
                  <h1>輝煌伺服器贊助</h1>
                  <p>支持我們，讓輝煌伺服器更加輝煌！請填寫以下資訊以完成贊助。</p>
                  <form id="donationForm" onsubmit="return handleSubmit(event)">
                      <div class="form-group">
                          <label for="minecraftName">Minecraft ID</label>
                          <input type="text" id="minecraftName" name="minecraftName" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="comment">贊助訊息（選填）</label>
                          <textarea id="comment" name="comment" rows="3"></textarea>
                      </div>
                      <div class="checkbox-group">
                          <input type="checkbox" id="check-tos" name="check-tos">
                          <label for="check-tos">我同意服務條款</label>
                      </div>
                      <button type="submit" class="cool-btn">提交贊助</button>
                  </form>
                  <div class="footer" onclick="window.open('https://github.com/nelsonGX/toiletw.net', '_blank')">site by Nelson.</div>
              </div>
              ...
              <script>
                  function handleSubmit(event) {
                      ...
                      if (!document.getElementById("check-tos").checked) {
                          alert('倘若想要進行贊助，您必須同意服務條款之規定。');
                          return false;
                      }

                      if (!$('#minecraftName').val().length) {
                          alert('請填寫有效的 Minecraft ID。');
                          return false;
                      }

                      if (!$('#discordTag').val().length) {
                          alert('您必須要填寫有效的 Discord Tag。');
                          return false;
                      }
                      ...
                      let formData = $('#donationForm').serializeArray();
                      formData = formData.map(item => {
                          if (item.name === 'discordTag') {
                              return { name: 'discordTag', value: discordTagWithHash };
                          }
                              ...
                              paymentWindow.document.write(`
                                  ...
                                  <body>
                                      <div class="container">
                                          ...
                                          ${messageLines}
                                          ${barcodeImageHtml}
                                          <p>如有任何問題，請聯繫 ricechen@brilliantw.net</p>
                                      </div>
                                  </body>
                                  </html>
                              `);
