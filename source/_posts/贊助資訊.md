...
<table>
  ...
  <tr>
    ...
    <td>2. 每日任務數量增加 <font color="#ff4e4e">5</font> → <font color="#b5fe4e">7</font> 個。</td>
    <td rowspan="4">2. 每日登入 <font color="#e6bbf6">10</font> 個。</td>
  </tr>
  <tr>
    <td>3. 每周任務數量增加 <font color="#ff4e4e">3</font> → <font color="#b5fe4e">5</font> 個。</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>2. 每日任務數量增加 <font color="#ff4e4e">5</font> → <font color="#b5fe4e">9</font> 個。</td>
    <td rowspan="6">2. 每日登入 <font color="#e6bbf6">10</font> 個。</td>
  </tr>
  <tr>
    <td>3. 每周任務數量增加 <font color="#ff4e4e">3</font> → <font color="#b5fe4e">8</font> 個。</td>
  </tr>
  <tr>
    <td>4. 在攻略副本中可額外獲取 <font color="#f7e1a4">15 %</font> 的獲利。</td>
  </tr>
  <tr>
    <td>5. 在普通任務中可獲取額外 <font color="#f7e1a4">15%</font> 的獲利。</td>
  </tr>
  <tr>
