...
<input class="textInput" id="minecraftName" name="name" type="text" placeholder="範例：RiceChen_" onfocusout="checkMinecraftNameWithProxy()" required>
...
<div class="textInputWrapper">
<input class="textInput" id="discordTag" name="discordTag" type="text" placeholder="範例：Rice Chen.#0707" onfocusout="checkDiscordTagWithProxy()" required>
...
- 贊助金額（新台幣）
<div class="textInputWrapper">
<input class="textInput" id="donate-amount" name="donateAmount" type="text" placeholder="一次最低 30 元 最高 10000 元" onfocusout="checkAmount()" min="30" max="10000" required>
...
- 贊助留言（可留空）
<div class="textInputWrapper">
<input class="textInput" id="comment" name="comment" type="text" placeholder="範例：我愛輝煌">
</div>
