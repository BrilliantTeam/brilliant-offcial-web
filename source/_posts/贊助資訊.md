      ...
      if (name.length > 0) {
         ...
         .then(data => {
             if (data.data?.userExists) {
                  ...
                  if ($('#minecraftName').hasClass('border-danger')) $('#preserve-minecraft-name').removeClass('border-danger');
                  if ($('#minecraftName').hasClass('border-success')) return;
                  $('#minecraftName').addClass('border-success');
                  $('#minecraftName').attr('style', 'color: green');
             } else {
                  $('#preserve-minecraft-name').text('你似乎沒有進入過輝煌伺服器，請加入過至少一次再填寫此欄位，也有可能是你「遊戲ID」寫錯了。');
                  if ($('#minecraftName').hasClass('border-success')) $('#preserve-minecraft-name').removeClass('border-success');
                  if ($('#minecraftName').hasClass('border-danger')) return;
                  $('#minecraftName').addClass('border-danger');
                  $('#minecraftName').attr('style', 'color: red');
             }
         })
         .catch(() => {});
      }
