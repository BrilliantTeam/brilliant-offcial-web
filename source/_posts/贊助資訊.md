...
- 已累積贊助金額（新台幣，可選，不影響最終支付金額）   
<div class="col-6 calculator-container">
<input class="form-control bg-dark" id="cumulative-amount" name="cumulativeAmount" type="text" placeholder="輸入已累積贊助金額（可留空）" oninput="calculateWatercress()">
</div>
