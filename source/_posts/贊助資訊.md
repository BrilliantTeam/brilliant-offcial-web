...
└ Discord 贊助者身份組 (可在 Discord群 各種雜談 嵌入連結的權限) 
...
├ Minecraft 解鎖` 7 `個額外終界箱空間 ( 共` 8 `個 ) 

├ Minecraft 解鎖第` 4 `行的額外終界箱空間 

├ Minecraft 隨身背包擴大至` 3×9 `的大小 

├ Minecraft 隱藏商品上架者的名稱
...
├ Minecraft 解鎖` 6 `個額外終界箱空間 ( 共` 14 `個 ) 

├ Minecraft 解鎖第` 5 `行的額外終界箱空間 

├ Minecraft 隨身背包擴大至` 4×9 `的大小 

├ Minecraft 設置上架商品永不到期
...
├ Minecraft 解鎖` 7 `個額外終界箱空間 ( 共` 21 `個 ) 

├ Minecraft 解鎖第` 6 `行的額外終界箱空間 
...
├ Minecraft 解鎖` 6 `個額外終界箱空間 ( 共` 27 `個 ) 
