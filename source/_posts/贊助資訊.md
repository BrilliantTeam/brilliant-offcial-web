...
<font size="5">有關贊助福利詳細說明，可至 <font color="#a4ff88"><a href="https://donation-docs.brilliantw.net/">此 Google 表單查看</a></font></font> ！
...
<table>
  ...
  <tr>
    <td>/donatefly buy <font color="#ffbb06">【飛行點數】</font>（三服無法使用）</td>
...
{% note warning %}
1. 稱號字數最多 4 個字 + 最多 1 本群靜態表符。
2. 稱號中只能使用一種顏色代碼，可使用十六進制色碼。
3. 稱號名不可與官方、活動、乙太、水芥 稱號相似，避免誤會。
4. 稱號名稱不可違反服規二所規範內容。
5. 稱號建立後，不得修改。
6. 稱號為跨分流給予。（第一、二、三分流）
{% endnote %}
