...
window.onload = function() {
  function calculateWatercress() {
    let amount = $('#donate-amount').val();
    let watercress = 0;
    if (amount && !isNaN(amount) && amount >= 30 && amount <= 10000) {
      amount = parseInt(amount);
      watercress = amount;

      if (amount > 170 && amount < 470) {
        watercress += 200;
      } else if (amount > 470 && amount < 970) {
        watercress += 200 + 580;
      } else if (amount > 970 && amount < 1170) {
        watercress += 200 + 580 + 1210;
      } else if (amount > 1170 && amount < 1970) {
        watercress += 200 + 580 + 1210 + 1590;
      } else if (amount > 1970 && amount < 2470) {
        watercress += 200 + 580 + 1210 + 1590 + 2620;
      } else if (amount > 2470 && amount < 2970) {
        watercress += 200 + 580 + 1210 + 1590 + 2620 + 2820;
      } else if (amount > 2970 && amount < 3470) {
        watercress += 200 + 580 + 1210 + 1590 + 2620 + 2820 + 3270;
      } else if (amount > 3470 && amount < 3970) {
    ...
    $('#Watercress-output').text(watercress > 0 ? `水芥: ${watercress} 個` : '');
  }
