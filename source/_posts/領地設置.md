...
設置領地需花費每格 <span class="label label-warning"><a href="https://www.brilliantw.net/獲取貨幣#轉換為乙太">0.2 乙太</a></span>，不計入高度格數。
...
<table style="width:auto;height:400px;">
				...
				<tr style="height: 20px">
					<td class="s3" dir="ltr">boarding</td>
					<td class="s3" dir="ltr">乘坐載具</td>
					<td class="s4" dir="ltr">❌</td>
					<td class="s3" dir="ltr">玩家是否可以使生物乘坐上載具</td>
					<td></td>
				</tr>
				<tr style="height: 20px">
				...
				<tr style="height: 20px">
					...
					<td class="s3" dir="ltr">這也包括了活動道具是否可以射出子彈</td>
				</tr>
				<tr style="height: 20px">
				...
				<tr style="height: 20px">
					<td class="s3" dir="ltr">usemap</td>
					<td class="s3" dir="ltr">使用地圖</td>
					<td class="s4" dir="ltr">✅</td>
					<td class="s3" dir="ltr">玩家是否可以使用空白地圖繪製地形</td>
					<td></td>
				</tr>
</table>
