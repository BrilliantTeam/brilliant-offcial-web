...
<html dir="ltr" lang="zh_TW" class="offline">
...
<body id="t" class="neterror" style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 75%" jstcache="0">
  ...
  <div role="application" tabindex="0" title="Dino game, play" class="runner-container"><canvas class="runner-canvas"
    ...
    class="slow-speed-option hidden">Start slower<input type="checkbox" title="慢速模式" tabindex="0"
      checked="checked"><span class="slow-speed-toggle"></span></label></div>
  <div id="sub-frame-error" jstcache="0">
    <!-- Show details when hovering over the icon, in case the details are
           hidden because they're too large. -->
    <div class="icon" jstcache="0"></div>
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1" style="display: none;">
    </div>
  </div>

  <div id="offline-resources" jstcache="0">
    <img id="offline-resources-1x"
      src="https://cdn.discordapp.com/attachments/596718421966716928/1097165354708504627/AddText_04-16-10.23.06.png"
      jstcache="0">
  ...
  <script jstcache="0">// Copyright 2012 The Chromium Authors
    // Use of this source code is governed by a BSD-style license that can be
    // found in the LICENSE file.
  ...
  <script
    jstcache="0">const pageData = {"dinoGameA11yAriaLabel":"飯娘 Dino","dinoGameA11yDescription":"飯娘 Dino，按下空格鍵（手機點螢幕）來躲避障礙物","dinoGameA11yGameOver":"遊戲結束！ 你的分數為：$1","dinoGameA11yHighScore":"你的最高分數為$1.","dinoGameA11yJump":"跳！","dinoGameA11ySpeedToggle":"慢速模式","dinoGameA11yStartGame":"遊戲開始！","errorCode":"","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"dino","msg":"按下空格鍵（手機點螢幕）來開始遊戲！"},"iconClass":"icon-offline","language":"zh-TW","textdirection":"ltr","title":"？？？/"};loadTimeData.data = pageData;var tp = document.getElementById('t');jstProcess(new JsEvalContext(pageData), tp);</script></body></html>  <!-- <script>
    var dummy = Runner.prototype.gameOver;
    Runner.prototype.gameOver = function () { };
  </script> -->
  
  <div style="float: left;">
    <a href="https://www.brilliantw.net/" title="https://www.brilliantw.net/" style="font-size: 20px;"> <strong>回到官網</strong> </a>
  </div>

  <div style="text-align: center; padding: 30px;">
    Copyright © 輝煌團隊 Brilliant Team 版權所有 All rights reserved<br />強烈建議網頁縮放大小調整至 200 %<br />以獲取最佳遊玩體驗！
  </div>
...
<html dir="ltr" lang="zh-TW" class="offline">
...
<body id="t" class="neterror" style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 75%" jstcache="0">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        <h1 jstcache="0">
          <span jsselect="heading" jsvalues=".innerHTML:msg" jstcache="9">按下空格鍵即可開始遊戲（手機點螢幕）</span>
    ...
    <div role="application" tabindex="0" title="開始暢玩 魬娘 Dino" class="runner-container"><canvas class="runner-canvas"
        width="1200" height="300" style="width: 600px; height: 150px;"></canvas><span class="offline-runner-live-region"
        aria-live="assertive">已啟動遊戲。</span></div><label
      class="slow-speed-option hidden">啟用慢速模式<input type="checkbox" title="啟用慢速模式" tabindex="0"
  ...
  <script
    jstcache="0">const pageData = {"dinoGameA11yAriaLabel":"開始暢玩 飯娘 Dino","dinoGameA11yDescription":"在這款遊戲中，你要協助在畫面中奔馳的像素風飯娘閃避障礙物。聽見提示音效時，按下空白鍵即可躍過障礙物。","dinoGameA11yGameOver":"遊戲結束，你的得分為 $1。","dinoGameA11yHighScore":"最高得分為 $1。","dinoGameA11yJump":"跳起來！","dinoGameA11ySpeedToggle":"啟用慢速模式","dinoGameA11yStartGame":"已啟動遊戲。","errorCode":"","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"dino","msg":"按下空格鍵即可開始遊戲！（手機點螢幕）"},"iconClass":"icon-offline","language":"zh-TW","textdirection":"ltr","title":"？？？/"};loadTimeData.data = pageData;var tp = document.getElementById('t');jstProcess(new JsEvalContext(pageData), tp);</script></body></html>
