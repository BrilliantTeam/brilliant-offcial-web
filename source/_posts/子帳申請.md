...
但倘若您以下某一條件 <span class="label label-info">不達標</span> 或 <span class="label label-info">違反</span> ，我們會直接 <span class="label label-info">否決</span> 您的申請，
或者給予警告處分：
...
- 您的 <span class="label label-info">Discord 名稱</span><span class="label label-info">#四位數號碼</span>（大小寫需正確 例如：<span class="label label-info">RiceChen_</span><span class="label label-info">#0707</span>  ）
...
- 欲申請帳號的 <span class="label label-info">遊戲 ID</span> （大小寫需正確 / <span class="label label-info">基岩版玩家</span> 請在 ID 前加上半形句號 <span class="label label-info"> . </span> ）
<div class="col-6">
...
- 欲申請帳號的 <span class="label label-info">Discord 名稱</span><span class="label label-info">#四位數號碼</span>（大小寫需正確 例如：<span class="label label-info">RiceChen_</span><span class="label label-info">#0707</span>）
- 倘若您已更改為 <span class="label label-info">新版 ID</span> ，請輸入  <span class="label label-info">Discord 名稱</span><span class="label label-info">#0</span> ，例如： <span class="label label-info">ricechen_</span><span class="label label-info">#0</span> 
<div class="col-6">
