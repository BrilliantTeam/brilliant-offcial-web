...
在申請時您需要提供以下資訊給予輝煌團隊進行判斷：
           ...
           5. 為什麼您需要使用子帳戶 ( 需詳細說明原因，這是審核的重要評斷，最多 200 個字元 )
...
- 為什麼您需要使用子帳戶（需詳細說明原因，這是審核的重要評斷，最多 200 個字元）
<div class="col-6">
<input class="form-control bg-dark" id="comment" name="comment" type="text" placeholder="範例：自己想 :P"  input type="text" maxlength="200" required>
